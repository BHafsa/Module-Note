...
use humhub\modules\Note\models\Etudiant;
use humhub\modules\Note\models\Niveau;
use humhub\modules\Note\utils\FPDF\FPDF;
use Yii;
		...
		if(isset($_GET["anneeEtud"])) //Si année saisit 
    		{
    			...
    			$anneeEtude=date('Y'); } //prendre l'anné en court
			...
			//récupérer les notes de l'étudiant selon l'anné d''étude
